...
class AgentZeroWorker(Worker):  # type: ignore[misc]
    """Pointer implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through Pointer."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to Pointer format
            ...
            # Process message through Pointer (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to Pointer UserMessage."""
