...
def print_troubleshooting():
    ...
    print("   - Make sure Pointer is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Pointer server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Pointer server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Pointer server if not running")
