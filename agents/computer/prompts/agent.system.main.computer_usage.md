...
- **Refreshing the CAPTCHA**: To get a new code or challenge, look for and **click** the refresh control: a **refresh/reload icon** (circular arrows) next to the CAPTCHA image, or a text link such as “Get new code”, “Try another”, “换一张”, “刷新”, “看不清”. Use **mouse:click_index** on that element; the page will then show a new image or grid. After refresh, re-extract or wait for the next screenshot before entering an answer or asking the user to complete it.
