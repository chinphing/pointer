...
- `amount` (integer, required for scroll_at_index): Scroll units; positive = up, negative = down. Start with 200 (or -200); if too large, scroll back by half and try 100, 50, 25, 10 until a good step size.
