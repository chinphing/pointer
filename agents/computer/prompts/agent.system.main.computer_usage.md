...
- **Checkbox / “I’m not a robot”**: You can **click the checkbox** (e.g. **mouse:click_index** on the checkbox or “Verify” button). If a follow-up image challenge appears (e.g. “Select all traffic lights”), you may try **mouse:click_index** or **modified_click:modified_click_index** on the matching tiles if they are clearly labeled in the annotated screenshot; if the UI is unclear or keeps failing, tell the user to complete it manually.
