...
|---|---|---|
| Select All | `command+a` | `keys ["command","a"]` |
| Copy | `command+c` | `keys ["command","c"]` |
| Paste | `command+v` | `keys ["command","v"]` |
| Cut | `command+x` | `keys ["command","x"]` |
| Focus Address Bar | `command+l` | `keys ["command","l"]` |
| New Tab | `command+t` | `keys ["command","t"]` |
| Close Tab | `command+w` | `keys ["command","w"]` |
| Close Window | `command+w` | `keys ["command","w"]` |
| Refresh | `command+r` | `keys ["command","r"]` |
| Find | `command+f` | `keys ["command","f"]` |
| Page Down / Scroll down | `space` | `keys ["space"]` |
| Page Up / Scroll up | `shift+space` | `keys ["shift","space"]` |
| Scroll to bottom | `command+down` | `keys ["command","down"]` |
| Scroll to top | `command+up` | `keys ["command","up"]` |
